                            ...
                            <div class="auth-box">
								...
								<div class="check-password">
								    ...
								    <div class="input-group">
								        ...
								        id="check-password" style="margin-bottom:0; padding-bottom:0;">확 인</button>
								    </div>
								    <p id="password-message" class="error-message" style="margin-top:0; padding-top:0;">비밀번호가 일치하지 않습니다.</p>
								</div>
                                <div class="input-group">
								...
								<div class="input-group">
                                    <input type="email" class="form-control" id="email-input" placeholder="이메일을 입력해주세요">
                            		<button type="button" class="btn btn-primary btn-md waves-effect m-b-20" id="email-check">인증번호 받기</button>
                                    <span class="md-line"></span>
                                </div>
                                <div class="input-group">
                                     <input type="text" class="form-control" placeholder="인증번호를 입력해주세요" style="margin-bottom:0; padding-bottom:0;">
                                     <button type="button" class="btn btn-primary btn-md waves-effect m-b-20" 
 ...
 // Email verification
    $("#email-check").on("click", function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                alert(response); // "Verification email sent."
            },
    ...
    $("#email-verify").on("click", function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                alert(response); // "Verification successful."
            },
            error: function(xhr, status, error) {
                alert("Error: " + xhr.responseText);
            }
