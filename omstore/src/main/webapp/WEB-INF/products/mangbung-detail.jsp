...
<body class="animsition">
	...
	<div class="container">
		<div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg">
			<a href="MainPage" class="stext-109 cl8 hov-cl1 trans-04">
				Home
					...
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="slick3 gallery-lb">
								<div class="item-slick3" data-thumb="${mangbung.image}">
									<div class="wrap-pic-w pos-relative">
										<img src="${mangbung.image}" alt="망붕이카드">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="${mangbung.image}">
			...
			<div class="bor10 m-t-50 p-t-43 p-b-40">
				...
				<div class="tab01">
					...
					<ul class="nav nav-tabs" role="tablist">
						...
						<li class="nav-item p-b-10">
							<a class="nav-link" data-toggle="tab" href="#information" role="tab">추가 정보</a>
						</li>
									...
									<div class="p-b-30 m-lr-15-sm">
										...
										<div class="flex-w flex-t p-b-68">
											<div class="wrap-pic-s size-109 bor0 of-hidden m-r-18 m-t-6">
												<img src="${path}/image/mbimage.png" alt="사용자이미지">
											</div>
											...
											<div class="size-207">
												...
												<p class="stext-102 cl6">
													카드 스티커가 정말 귀엽고 카드에 딱 맞아서 뜨는 부분이 없습니다!
													정말 좋아요!
												</p>
											</div>
										</div>
							...
							<div class="wrap-slick3 flex-sb flex-w">
								...
								<div class="slick3 gallery-lb">
									<div class="item-slick3" data-thumb="images/product-detail-01.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="${path}/image/odung2.jpg" alt="오둥이">
...
<!--===============================================================================================-->
	...
	$(document).ready(function() {
	    $('.js-addcart-detail').on('click', function() {
	        var productDetail = $(this).closest('.row');
	        
	        var productName = productDetail.find('.js-name-detail').text().trim();
	        var productPriceText = productDetail.find('.js-price-detail').text().trim();
	        var quantityText = productDetail.find('.num-product').val();
	        var productImg = productDetail.find('img').attr('src'); // 이미지 URL을 가져옵니다.
	        ...
	        // 가격에서 숫자만 추출
	        var productPrice = productPriceText.replace(/[^0-9.]/g, '');
	        if (isNaN(parseFloat(productPrice))) {
	            alert('유효하지 않은 가격 값입니다.');
	            return;
	        }
	        ...
	        if (isNaN(quantity) || quantity <= 0) {
	            alert('유효하지 않은 수량 값입니다.');
	            return;
	        }

	        var userid = "${users.userid}"; // 실제 사용자 ID로 대체

	        // userid가 올바르게 설정되었는지 확인
	        if (!userid) {
	        ...
	        $.ajax({
	            ...
	            success: function(response) {
	                ...
	                if (response.success) {
	                    ...
	                    alert('장바구니 담기 실패: ' + (response.message || 'Unknown error'));
	                }
	            },
	            error: function(xhr, status, error) {
	                // 요청이 실패한 경우 처리
	                console.error('AJAX Error:', status, error);
	                alert('장바구니에 담기 요청이 실패했습니다.');
	            }
	        });
	    });
	});
