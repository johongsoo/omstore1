                        ...
                        <div class="slick3 gallery-lb">
                            <div class="item-slick3" data-thumb="${odung.image}">
                                <div class="wrap-pic-w pos-relative">
                                    <img src="${odung.image}" alt="망붕이카드">

                                    <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="${odung.image}">
                ...
                <div class="p-r-50 p-t-5 p-lr-0-lg">
                    ...
                    <div class="p-t-33">
                        <div class="flex-w flex-r-m p-b-10">
                            <!-- You can add quantity options or other features here -->
                        </div>
