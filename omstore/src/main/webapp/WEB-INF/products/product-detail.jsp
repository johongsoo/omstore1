				...
				<nav class="limiter-menu-desktop container">
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							...
							<li>
								<a href="mangbunglist">망붕스토어</a>
							</li>
							<li class="label1" data-label1="hot">
								<a href="ranklist">랭킹</a>
							</li>
							<li>
								<a href="blog.html">게시판</a>
							</li>
							...
							<div class="slick3 gallery-lb">
								<div class="item-slick3" data-thumb="${product.image}">
									<div class="wrap-pic-w pos-relative">
										<img src="${product.image}" alt="망붕이카드">
								...
								<div class="size-204 respon6-next">
									<div class="rs1-select2 bor8 bg0">
										<select class="js-select2" name="time">
											...
											<option>스티커 디자인1</option>
											<option>스티커 디자인2</option>
											<option>스티커 디자인3</option>
										</select>
