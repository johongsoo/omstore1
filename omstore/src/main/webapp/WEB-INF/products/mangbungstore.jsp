	...
	<div class="bg0 m-t-23 p-b-140">
		<div class="container">
			...
			<div class="row isotope-grid">
				<c:forEach var="mangbung" items="${mangbunglist}">
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item cushion">
					<!-- Block2 -->
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="${mangbung.image}" alt="IMG-PRODUCT" onclick="detail(${mangbung.productsid})">

							<a href="#" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1"
							data-name="${mangbung.name}" 
   							data-price="${mangbung.price} 원" 
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6" onclick="detail(${mangbung.productsid})">
									${mangbung.name}
								</a>
