	...
	document.addEventListener('DOMContentLoaded', function() {
	    ...
	    quickViewButtons.forEach(button => {
	        button.addEventListener('click', function(e) {
	            ...
	            // 버튼의 data 속성에서 제품 정보 가져오기
	            const name = this.getAttribute('data-name');
	            const price = this.getAttribute('data-price');
	            const image = this.getAttribute('data-image');

	            // 모달의 데이터 업데이트
	            document.getElementById('modal-name').textContent = name || 'No Name Available';
	            document.getElementById('modal-price').textContent = price || 'No Price Available';
	            document.getElementById('modal-image').setAttribute('src', image);
	            document.getElementById('modal-image-link').setAttribute('href', image);
